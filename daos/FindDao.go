...
//)
//
//func FindData(canShu interface{}) interface{} {
//	//select ?,?,? from kus.biaos where key1=? and key2=?
//	caoZuoKu := canShu[consts.ShuJuKu].(string)
//	caoZuoBiao := canShu[consts.ShuJuBiao].(string)
//	caoZuoZhis := canShu[consts.ShuJuZhis].(interface{}) //把需要查询的字段拿出来
//	tiaoJians := canShu[consts.TiaoJians].(interface{})  //把条件拿出来
//	dangQianYe := ""
//	meiYeTiaoShu := ""
//
//	wenHaos := []string{}
...
//}
//
//func scanRet(lies []string, rows *sql.Rows) []interface{} {
